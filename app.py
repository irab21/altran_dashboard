...
if password == "altran@2020":
	...
	st.write('\n\n')
	st.write('\n\n As can be seen, out of %s total selections:\n\n %s candidates were offered \n\n Out of which, %s Candidates were Positively Converted \n\n %s Candidates were not Converted \n\n %s Candidate Conversions are still Pending '%(total_selections1.values[0],offer_count.values[2],total_selections.values[1,2],total_selections.values[0,0],total_selections.values[1,1]))
...
#	st.write(df)
	...
	st.write("Hiring was done for the ***Gurugram,Bangalore,Pune,Hyderabad and Noida*** Locations")
