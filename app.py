...
if password == "altran@2020":
	...
	st.write('\n\n')
	st.write('\n\n As can be seen, out of %s total selections:\n\n Out of which, %s candidates were offered \n\n %s Candidates were Positively Converted \n\n %s Candidates were not Converted \n\n %s Candidate Conversions are still Pending '%(offer_count.values[1],total_selections1.values[0],total_selections.values[2,2],total_selections.values[0,0],total_selections.values[1,1]))
